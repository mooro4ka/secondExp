...
import nsida.kazey.showcase.view.SettingsModeController;
...
public class MainApp extends Application {
	...
	private Scene settingsModeScene = null;
	private static String appFolder = null;
	private PackingController packingController;
	private SettingsModeController settingsModeController;
	...
	public void setSettingsModeScene() {
		primaryStage.setTitle("SettingsMode");
		primaryStage.setScene(settingsModeScene);
		primaryStage.setFullScreen(true);
	}
	...
	private void initSettingsMode(){
		...
		try {
			...
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(MainApp.class.getResource("view/SettingsModeLayout.fxml"));			
			AnchorPane page = (AnchorPane) loader.load();
